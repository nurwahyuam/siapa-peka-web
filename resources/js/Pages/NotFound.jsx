...
export default function NotFound (){
    return (
        ...
        <div className="flex flex-col items-center justify-center min-h-screen text-center bg-gradient-to-br from-indigo-400 via-indigo-300 to-indigo-200">
            <h1 className="font-bold text-[200px] leading-none text-white">404</h1>
            <p className="text-[30px] leading-tight text-white">Halaman yang anda cari tidak ada!</p>
            <a 
            href={route("welcome")}
            className="bg-white mt-5 text-2xl px-5 py-3 rounded-full 
