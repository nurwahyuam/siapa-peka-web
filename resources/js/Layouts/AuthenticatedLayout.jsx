        ...
        <header className="bg-white border-b border-gray-200 lg:hidden flex-shrink-0">
          <div className="flex items-center justify-between px-4 py-3">
            ...
            <div className="flex items-center">
              <img src="assets/dp3ak.png" className="h-6 w-auto mr-2" alt="Logo" />
              <span className="text-lg font-bold text-gray-800">Siapa Peka</span>
            </div>
            <div className="w-6"></div> {/* Spacer untuk balance layout */}
          </div>
        </header>
